...
namespace Raven
{
    P2PClientBase::P2PClientBase(int localPort, std::string serverIp, int serverPort, EndPointType type) : ClientBase(localPort, serverIp, serverPort), endPointType(type)
    {
    }
